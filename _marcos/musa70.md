...
1. Manipular acordes cromáticos de sétima, sexta aumentada e napolitana no contexto da música tonal.
2. Identificar acordes cromáticos de sétima, sexta aumentada e napolitana em obras musicais.
3. Identificar passagens modulatórias em obras musicais.
4. Identificar e manipular a harmonia de forma a criar modulações.
6. Aprimorar a escrita a quatro vozes com sonoridades cromáticas.

## 3. Pré-requisitos

São pré-requisitos para esta disciplina:

1. Condução de vozes (quatro vozes).
2. Habilidade de manipular acordes de sétima da dominante.
3. Habilidade de manipular acordes de função secundária (dominante e sensível).
...
-->
  ...
  1. Clementi, op. 36, n. 2, mov. 1.
  1. Clementi, op. 36, n. 3, mov. 1.
  ...
  1. Haydn XVI/32 N. 47 Si menor, mov. 1 (apenas primeira página)
  1. Haydn XVI/34 N. 47 Mi menor, mov. 1
  1. Kuhlau, Op. 59 N. 1, mov. 1 (apenas primeira página)
  1. Mozart K173, mov. 1 (p 99 (5). Final do movimento)
  1. Mozart K280, mov. 1 (apenas primeira página)
  1. Mozart K284, mov. 3, Tema (p. 10 (54))
  1. Mozart K310, mov. 1 (apenas primeira pagina)
  1. Mozart K330, mov. 2 (p 111 (7))
  1. Mozart K333, mov. 1 (apenas primeira página)
  1. Mozart K545, mov. 1 (apenas a primeira página)
...
#### Análise harmônica e formal (combinação de frases)
...
- Beethoven Op. 2, n. 1, mov. 1 (duas primeiras páginas) - (cc. 8--20)
- Beethoven Op. 10, n. 1, mov. 1 (cc. 32--56)
- Clementi Op. 36, n. 3, mov. 1 (inteira, não é Forma Sonata)
- Clementi, Op. 1, n. 5 (duas primeiras páginas) (cc. 8--12)
- Haydn XVI/32 Sonata em Si menor, mov. 1 (cc. 9--13)
- Haydn XVI/34 Sonata em Mi menor, mov. 1 (duas primeiras páginas) (cc. 9--29)
- Kuhlau, Op. 59, n. 1, mov. 1 (cc. 9--21)
- Mozart K280, mov. 1 (cc. 13--27)
- Mozart K284, mov. 3, tema (não é Forma Sonata)
- Mozart K310, mov. 1 (cc. 9--23)
- Mozart K333, mov. 1 (cc. 10--22)
- Mozart K545, mov. 1 (duas primeiras páginas) (cc. 5--12)
- Mozart K570, mov. 1 (cc. 23--40)
...
| :-------- | :--- | :--- | :--- | :--- | :--- |
| 220119182 | -    | -    | -    | -    | -    |
| 221120503 | 8.2  | 9.2  | 4.4  | 7.3  | AP   |
| 222118661 | 5.4  | 6.5  | 1.3  | 4.4  | RP   |
| 223118611 | 3.0  | 0.0  | 4.0  | 2.3  | RP    |
| 223118632 | 9.2  | 10.0 | 4.8  | 8.0  | AP   |
| 223119867 | 7.1  | 7.4  | 4.5  | 6.3  | AP   |
| 224119561 | 8.0  | 9.6  | 9.0  | 8.9  | AP   |
| 224119562 | 5.7  | 4.1  | 4.0  | 4.6  | RP   |
| 224119571 | 9.4  | 8.1  | 6.9  | 8.1  | AP   |
| 224119573 | 8.1  | 9.5  | 8.6  | 8.7  | AP   |
| 224119574 | 6.3  | 8.1  | 4.7  | 6.4  | AP   |
| 224119576 | 9.3  | 10.0 | 10.0 | 9.8  | AP   |
| 224119578 | 6.3  | 5.8  | 6.0  | 6.0  | AP   |
| 224119580 | 10.0 | 9.1  | 9.2  | 9.4  | AP   |
| 224119581 | 8.1  | 8.9  | 6.7  | 7.9  | AP   |
{: .table .table-sm}
